...
export default function AnimatedButton({
  ...
  const isGetStartedButton = typeof children === "string" && children.toLowerCase().includes("get started")
  const finalHref =
    href ||
    (isGetStartedButton ? "https://calendly.com/dvin-warmleads/schedule-some-time-to-chat?month=2025-09" : undefined)
  ...
  const buttonContent = (
    <motion.div
      ...
      initial="initial"
      onClick={disabled || finalHref ? undefined : handleClick}
    >
